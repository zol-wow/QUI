        ...
        quiGroupFrames = {
            ...
            party = {
                ...
                healer = {
                    ...
                    defensiveIndicator = { enabled = false, iconSize = 16, maxIcons = 3, spacing = 2, growDirection = "RIGHT", position = "CENTER", offsetX = 0, offsetY = 0, reverseSwipe = true, durationTextOverride = false, durationTextSize = 12 },
                },
