...
function QUI_Anchoring_Options:CreateSnapButton(parent, text, x, y, width, height, onClick)
    ...
    ns.SkinBase.ApplyPixelBackdrop(button, 1, true, false, { C.border[1], C.border[2], C.border[3], 1 }, dbg)
...
function QUI_Anchoring_Options:CreateAnchorPointSelector(parent, label, settingsDB, key, x, y, onChange, size)
    ...
    ns.SkinBase.ApplyPixelBackdrop(grid, 1, true, true, { C.border[1], C.border[2], C.border[3], 0.5 }, gridBg, nil, nil, 1)
    ...
    for row = 1, 3 do
        ...
        for col = 1, 3 do
            ...
            ns.SkinBase.ApplyPixelBackdrop(cell, 1, true, false, { C.border[1], C.border[2], C.border[3], 0.3 }, cellBg)
...
function QUI_Anchoring_Options:CreateMultiAnchorPopover(anchorButton, settingsDB, onChange, anchorsKey, maxAnchors)
    ...
    ns.SkinBase.ApplyPixelBackdrop(popover, 1, true, true, { C.accent[1], C.accent[2], C.accent[3], 1 }, { C.bg[1], C.bg[2], C.bg[3], 0.98 }, nil, nil, 2)
    ...
    local function RebuildAnchors()
        ...
        for i, anchor in ipairs(anchors) do
            ...
            ns.SkinBase.ApplyPixelBackdrop(rowFrame, 1, true, true, { C.border[1], C.border[2], C.border[3], 0.3 }, { C.bg[1] * 1.2, C.bg[2] * 1.2, C.bg[3] * 1.2, 0.5 }, nil, nil, 2)
...
function QUI_Anchoring_Options:CreateMultiAnchorDialog(settingsDB, onChange, anchorsKey, maxAnchors)
    ...
    ns.SkinBase.ApplyPixelBackdrop(dialog, 2, true, true, { C.accent[1], C.accent[2], C.accent[3], 1 }, { C.bg[1], C.bg[2], C.bg[3], C.bg[4] or 0.98 }, nil, nil, 4)
    ...
    ns.SkinBase.ApplyPixelBackdrop(titleBar, 0, true, false, nil, { C.bgLight[1], C.bgLight[2], C.bgLight[3], 1 })
