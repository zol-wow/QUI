...
C_GossipInfo C_GuildInfo C_IncomingSummon C_LevelLink C_Map C_MountJournal C_MythicPlus C_PaperDollInfo
C_PetBattles C_PlayerInfo C_PvP C_QuestLog C_SpecializationInfo C_SummonInfo C_TaskQuest C_TransmogCollection
C_UIWidgetManager C_WowTokenPublic CanExitVehicle CanGuildBankRepair CanInspect CanMerchantRepair ChallengesFrame ChallengesKeystoneFrame
...
GetMasteryEffect GetMaxLevelForPlayerExpansion GetMeleeHaste GetMinimapZoneText GetModifiedClick GetMoney GetMouseFoci GetMouseFocus
...
GetPetActionInfo GetPetActionSlotUsable GetPhysicalScreenSize GetPlayerInfoByGUID GetPowerBarColor GetPowerRegenForPowerType GetQuestDifficultyColor GetQuestProgressBarPercent
...
PickupPetAction PlaySound PlaySoundFile PlayerCastingBarFrame PlayerChoiceFrame PlayerFrame PlayerSpellsFrame PlayerSpellsMicroButton
PlayerUtil ProfessionsCustomerOrdersFrame QueueStatusButton QuickJoinToastButton RANGE_INDICATOR RED_FONT_COLOR_CODE RafRewardDeliveredAlertSystem RegisterStateDriver
...
ToggleFriendsFrame ToggleGameMenu ToggleGuildFrame ToggleHelpFrame TogglePlayerSpellsFrame ToggleProfessionsBook ToggleQuestLog ToggleSpellBook
...
UpdateMicroButtons UpdateMicroButtonsParent WOW_PROJECT_ID WOW_PROJECT_MAINLINE WardrobeFrame WardrobeTransmogFrame WeeklyRewardsFrame WorldMapFrame
