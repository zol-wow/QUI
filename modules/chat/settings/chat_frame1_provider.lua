...
ProviderPanels:RegisterAfterLoad(function(ctx)
    ...
    RegisterSharedOnly("chatFrame1", { build = function(content, key, width)
        ...
        CreateTileCollapsible(content, "Frame Size", 2 * FORM_ROW + 8, function(body)
            local sy = -4
        ...
        -- Intro Message
        CreateTileCollapsible(content, "Intro Message", 2 * FORM_ROW + 8, function(body)
            local sy = -4
        ...
        -- Default Tab
        CreateTileCollapsible(content, "Default Tab", 3 * FORM_ROW + 8, function(body)
        ...
        -- Chat Background
        if chat.glass then
            CreateTileCollapsible(content, "Chat Background", 3 * FORM_ROW + 8, function(body)
                local sy = -4
        ...
        if chat.editBox then
            CreateTileCollapsible(content, "Input Box Background", 5 * FORM_ROW + 8, function(body)
                local sy = -4
        ...
        -- Message Fade
        if chat.fade then
            CreateTileCollapsible(content, "Message Fade", 2 * FORM_ROW + 8, function(body)
                local sy = -4
        ...
        -- URL Detection
        if chat.urls then
            CreateTileCollapsible(content, "URL Detection", 2 * FORM_ROW + 8, function(body)
                local sy = -4
        ...
        -- Timestamps
        CreateTileCollapsible(content, "Timestamps", 4 * FORM_ROW + 8, function(body)
            local sy = -4
        ...
        -- UI Cleanup
        CreateTileCollapsible(content, "UI Cleanup", 2 * FORM_ROW + 8, function(body)
            local sy = -4
        ...
        -- Copy Button
        CreateTileCollapsible(content, "Copy Button", 2 * FORM_ROW + 8, function(body)
            local sy = -4
        ...
        -- Message History
        CreateTileCollapsible(content, "Message History", 2 * FORM_ROW + 8, function(body)
            local sy = -4
        ...
        -- New Message Sound
        CreateTileCollapsible(content, "New Message Sound", 1, function(body)
            local sy = -4
