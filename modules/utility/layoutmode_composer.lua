...
local function BuildBuffsSettings(content, gfdb, onChange)
    ...
    CreateComposerCollapsible(content, "Buffs", function(body, updateH)
        ...
        L:Row(GUI:CreateFormSlider(body, "Icon Size", 8, 32, 1, "buffIconSize", auras, syncedOnChange, nil, { description = "Pixel size of each buff icon." }), SLIDER_HEIGHT, cond)
...
local function BuildDebuffsSettings(content, gfdb, onChange)
    ...
    CreateComposerCollapsible(content, "Debuffs", function(body, updateH)
        ...
        L:Row(GUI:CreateFormSlider(body, "Icon Size", 8, 32, 1, "debuffIconSize", auras, syncedOnChange, nil, { description = "Pixel size of each debuff icon." }), SLIDER_HEIGHT, cond)
