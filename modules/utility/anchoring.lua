...
local FRAME_ANCHOR_INFO = {
    ...
    skyriding       = { displayName = "Skyriding",             category = "QoL",               order = 4 },
    petWarning      = { displayName = "Pet Warning",           category = "QoL",               order = 5 },
    focusCastAlert  = { displayName = "Focus Cast Alert",      category = "QoL",               order = 6 },
    missingRaidBuffs = { displayName = "Missing Raid Buffs",   category = "QoL",               order = 7 },
    mplusTimer      = { displayName = "M+ Timer",              category = "QoL",               order = 8 },
