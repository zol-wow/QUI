...
local function BuildKeybindsTab(tabContent)
    ...
    GUI:SetSearchContext({tabIndex = 3, tabName = "Cooldown Manager", subTabIndex = 7, subTabName = "Keybinds"})
...
local function BuildRotationAssistTab(tabContent)
    ...
    -- Set search context for auto-registration
    GUI:SetSearchContext({tabIndex = 3, tabName = "Cooldown Manager", subTabIndex = 8, subTabName = "Rotation Assist"})
